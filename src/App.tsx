...
class App extends Component<MyProps,MyState> {
    ...
    constructor(props: any){
      super(props);
      this.state = {currentQuestion: {},currentQuestionId: 0,isQuestionAttempted: {},isStarted: false,isCompleted: false, showResult: false};
    }
    ...
    return (
      <div className="App container-flux">
        ...
        
        {
          ...
          <div className="row">
            {data && <div className="align-left pl-5 font-weight-bold">Question {data.examState.id}</div>}
            {
           ...
           <div className="col-12 mt-3">
            <button type="button" className="btn btn-sm btn-secondary m-1" onClick= {()=> this.handelPreviousClick()}> Previous </button>
            {
              ...
              <button type="button" className="btn btn-sm btn-success m-1" onClick= {()=> this.handelNextClick()}> Next </button>
            } 
           </div>
          </div> :
          <div>
